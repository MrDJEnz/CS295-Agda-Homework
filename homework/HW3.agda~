...
isoto[≤/S<] Z = Z
isoto[≤/S<] (S m≤n) with isoto[≤/S<] m≤n
... | IH = S IH

-- Hint: use isoto[≤/S<]
isoto[S≤/<] : ∀ {m n : ℕ} → S m ≤ n → m < n
isoto[S≤/<] sm≤n with isoto[≤/S<] sm≤n
isoto[S≤/<] sm≤n | S IH = IH

-- Hint: do induction on m<n
isofr[S≤/<] : ∀ {m n : ℕ} → m < n → S m ≤ n 
isofr[S≤/<] Z = S Z
isofr[S≤/<] (S m<n) with isofr[S≤/<] m<n
... | IH = S IH

-- Hint: use isofr[S≤/<]
isofr[≤/S<] : ∀ {m n : ℕ} → m < S n → m ≤ n
isofr[≤/S<] m<sn with isofr[S≤/<] m<sn
isofr[≤/S<] m<sn | S IH = IH
