...
data _≤_ : ℕ → ℕ → Set where
  Z : ∀ {n} → Z ≤ n
  S : ∀ {m n} → m ≤ n → S m ≤ S n
-- curly is implicit args

-- trivaly true, but prove by induction
xRx[≤] : ∀ (m : ℕ) → m ≤ m
xRx[≤] Z = Z
xRx[≤] (S m) with xRx[≤] m
... | IH = S IH
...
lmono[+/≤] m n p m≤n with commu[+] m p | commu[+] n p
... | H1 | H2 rewrite H1 | H2  = rmono[+/≤] p m n m≤n
